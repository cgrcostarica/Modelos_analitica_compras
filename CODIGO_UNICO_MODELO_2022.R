...
Dist_consenso_NA <-Set_final_V2[,.N, keyby = .(idInstitucion,Nombre_Institucion, Consenso)][order(-Consenso)][]
...
Deciles_KMEANS <-quantile(puntaje_anomalia_KNN$score_KMEANS, probs = seq(0, 1, 0.1), na.rm = FALSE)
Deciles_KMEANS   

Set_final[, Escala_Nota_KMEANS := ifelse((score_KMEANS>=Deciles_KNN[1] & score_KMEANS<=Deciles_KNN[2]),
                                     10,(ifelse((score_KMEANS>Deciles_KNN[2] & score_KMEANS<=Deciles_KNN[3]),
                                                20,ifelse((score_KMEANS>Deciles_KNN[3] & score_KMEANS<=Deciles_KNN[4]),
                                                          30,ifelse((score_KMEANS>Deciles_KNN[4] & score_KMEANS<=Deciles_KNN[5]),
                                                                    40,ifelse((score_KMEANS>Deciles_KNN[5] & score_KMEANS<=Deciles_KNN[6]),
                                                                              50,ifelse((score_KMEANS>Deciles_KNN[6] & score_KMEANS<=Deciles_KNN[7]),
                                                                                        60,ifelse((score_KMEANS>Deciles_KNN[7] & score_KMEANS<=Deciles_KNN[8]),
                                                                                                  70,ifelse((score_KMEANS>Deciles_KNN[8] & score_KMEANS<=Deciles_KNN[9]),
                                                                                                            80,ifelse((score_KMEANS>Deciles_KNN[9] & score_KMEANS<=Deciles_KNN[10]),
                                                                                                                      90,ifelse((score_KMEANS>Deciles_KNN[10] & score_KMEANS<=Deciles_KNN[11]),
                                                                                                                                100,0)))))))))))]
...
Set_final[, Nota_final := Escala_Nota_ISO*0.25+Escala_Nota_KNN*0.25+Escala_Nota_LOF*0.25+Escala_Nota_RPCA*0.25]
...
#Creacion del data set para datastudio
